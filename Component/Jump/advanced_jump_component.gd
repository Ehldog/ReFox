...
# modele pour faire un saut variable en fonction de la relache du bouton saut
# ATTENTION: changer le jump_component du script principal par jump_component.handle_jump(self,input_component.get_jump_input(),input_component.get_jump_released())
...
# Gestion du saut
# ENTREE : un CharacterBody2D correspondant au character, la condition du saut provenant de input_component (ligne 16), la condition si l'input du saut est relaché de l'input_component (ligne 23)
# BUT : ensemble des conditions pour faire sauter le character
# SORTIE : void
